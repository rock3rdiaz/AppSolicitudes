...
class DivisionesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Divisiones'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Divisiones');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Divisiones']))
			$model->attributes=$_GET['Divisiones'];
	...
	{
		$model=Divisiones::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='divisiones-form')
		{
