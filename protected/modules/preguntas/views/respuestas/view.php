...
<?php $this->widget('bootstrap.widgets.TbDetailView',array(
	...
	'attributes'=>array(
		'idSolicitud',
		array('label'=>'Fecha envio solicitud', 'value'=>substr($model->idSolicitud0->fecha_envio, 0, 10)),		
		array('label'=>'Hora envio solicitud', 'value'=>substr($model->idSolicitud0->fecha_envio, 11, 8)),		
