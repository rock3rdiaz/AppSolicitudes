<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('idArea_origen')); ?>:</b>
	<?php echo CHtml::encode($data->idArea_origen); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('idUsuario_temporal')); ?>:</b>
	<?php echo CHtml::encode($data->idUsuario_temporal); ?>
	<br />
